...
coupling coefficient 耦合系数|investigate 调查|adequate 充足的|bias 偏差|
replicas 副本|constitute 构成|heterogeneous 错杂的|manifestations 表现|
...
modalities 方式||favorable 有利的|modular 模块化||
cardinality 基数||heterogeneous 异质的|progressively 逐步地||
pulmonary nodule 肺结节||ad hoc 特设的||
