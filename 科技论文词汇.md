...
|encompass 包括|preliminary experiment 初步实验|heuristic 启发式|due to 由于
...
arteries and veins 动脉和静脉|outperform 超过|remarkable 卓越的|perturbation 扰动|
End diastole 舒张末期|propagate 传播|modular 模块化|workhorse 主力|
End systole 收缩末期 |lever 利用|progressively 逐步地|artefacts 人工|
Ejection Fraction 射血分数|influx 涌入|reproducible 可重复性的|inhomogeneity 不均匀性|
left ventricle 左心室|counteract 抵消|apical 顶部的|chunk 块|
...
cardiologist 心脏病|obfuscate 混淆|subtle 微妙的||
Echocardiographic 超声心动图|confront 面对|aforementioned 前述的||
magnetic resonance (MR) imaging 核磁共振图|permute 置换|perceptible 可察觉的||
