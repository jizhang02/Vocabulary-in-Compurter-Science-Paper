...
21|ablation studies 消融研究|outperform 性能优于|robust 强大的|perturbation 扰动|adverse discrepancy 不利差异
...
27|convention 共识|penalize 惩罚|sufficiently 充足地|taxonomy 分类|ravel out 散开
...
85|model-agnostic 与模型无关|propelling 推进|methodological 方法上的|workhorse 主力|aside from 除了
...
98|trajectory 弹道|disentangles 解开|invasive 侵入性的|precursor 先导|
99|schizophrenia 精神分裂症|impinge 撞击|drastically 剧烈地|discrepancy 差异|
100|cardiovascular imaging 心血管图像|incorporate 合并|primordial 原始的|ingredient 成分|
101|hemodynamic 血液动力学|circumvent 规避|astounding 惊人的|intervention 介入|
102|abdominal imaging 腹部成像|superimpose 叠加|parenchymal 实质的|disparity 差距|
103|microscopy imaging 显微成像|sought 寻求|whereby 从而|offspring 后代|
104|cognitive impairment 认知障碍|achieve 实现|chronological 按时间顺序的|peculiarity 特色|
105|pediatric radiology 儿科放射学|delve 钻研|ubiquitous 无处不在的|inpainting 修补|
106|histopathology 组织病理学|discern 辨别|anisotropic 各向异性的|aberration 像差|
107|left ventricle 左心室||isotropic 各向同性的|alteration 改造|
108|right ventricle 右心室||cumbersome 麻烦的|distortion 畸变|
109|cavity 腔||Exemplary 示范性的|rationale 基本原理|
110|left atrium 左心房||overarching 总体的|Exemplar 范例|
111|group lasso 套索组||nonetheless 尽管如此|hypointense 低调|
112|apical view 顶视图||unduly 过分地|heterogeneity 异质性|
113|coronary artery stenosis 冠状动脉狭窄||forthcoming 即将来临的|prognosis 预测|
114|angiography 血管造影||inadequate 不足的|dysfunction 功能障碍|
115|myocardial infarction 心肌梗塞||admissible 可接受的|merits 优点|
116|||symbiotic 共生的|ambiguity 模棱两可|
117|||lethal 致命的|interference 干扰|
118|||infallible 可靠的|deformation 形变|
119|||detrimental 有害的|variations 变化|
120|||intact 完整的|interdependency 相互依存|
121|||concurrent 同时的|severity 严重程度|
122|||innate 先天的|indices 指标|
123|||paramount 首要的|quantification 量化|
124|||subtle 微妙的|relatedness 相关性|
125|||solely 独自的|violation 违法|
126|||therapeutic 治疗的|redundancy 冗余|
127|||aforementioned 前面提到的|convexity 凸度|
128|||vague 模糊的|dimensionality 维度|
129|||capricious 变化无常的|correlations 相关性|
130|||planar 平面的|homogeneity 同质性|
131|||imperceptible 不可察觉的|valve 阀门|
132|||tailored 量身定制的|magnitude 大小|
133|||intrinsic 固有的|singularity 奇点|
134|||seamlessly 无缝地|caveats 注意事项|
135|||intuitively 直观地|synonym 代名词|
136|||holonomic 完整的|proliferation 增殖|
137|||informative 信息丰富的|synergy 协同作用|
138|||rigorous 严格的|perimeter 周长|
139|||prime 主要的|cohort 队列|
140|||reciprocal 相互的|workloads 工作量|
141|||quadratic 二次的|prospect 前景|
142|||noninvasively 无创地||
143|||grounded 扎实的||
144|||seminal 开创性的||
145|||soundly 可靠地||
